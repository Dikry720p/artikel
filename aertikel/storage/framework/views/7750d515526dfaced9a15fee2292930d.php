    ...
    <div class="flex gap-10 w-full">
      ...
      <div id="menu"
        ...
        <ul
          ...
          <li><a href="<?php echo e(url('/')); ?>" class="text-primary hover:text-gray-600">Beranda</a></li>
  ...
  <div class="swiper mySwiper mt-9">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
        <a href="<?php echo e(url('detail-MotoGp')); ?>" class="block">
          <div
            class="relative flex flex-col gap-1 justify-end p-3 h-72 rounded-xl bg-[url('<?php echo e(asset('img/SW-Olahraga.png')); ?>')] bg-cover bg-center overflow-hidden">
            <div
            ...
            <div class="relative z-10 mb-3" style="padding-left: 10px;">
              ...
              <div class="flex items-center gap-1 mt-1">
                <img src="<?php echo e(asset('img/User.png')); ?>" alt="" class="w-5">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\OLDMAN\Documents\GitHub\artikel\aertikel\resources\views/index.blade.php ENDPATH**/ ?>