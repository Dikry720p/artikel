  ...
  <div class="flex flex-col items-center justify-center bg-white p-8 mt-8 mb-8 rounded-lg w-full max-w-lg py-20">
    ...
    <a href="<?php echo e(url('/')); ?>">
      <div class="flex gap-4 items-center mb-6">
        <img src="<?php echo e(asset('img/Logo.png')); ?>" class="h-14" alt="Logo">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\OLDMAN\Documents\GitHub\artikel\aertikel\resources\views/register.blade.php ENDPATH**/ ?>