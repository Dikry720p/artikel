...
@section('content')
    <div class="">
        ...
        <!-- Author -->
        <div class="flex gap-4 items-center mb-10 text-white p-10 bg-[url('{{ asset('img/bg-profile.png') }}')] bg-cover">
            <img src="{{ asset('img/profile.png') }}" alt="profile" class="rounded-full max-w-28 ">
            <div class="">
                ...
                <a href="{{ url('pariwisata') }}">
                    <div
                        ...
                        <div
                            ...
                            Pariwisata</div>
                        <img src="{{ asset('img/Berita-Liburan.png') }}" alt="" class="w-full rounded-xl mb-3">
                ...
                <a href="{{ url('politik') }}">
                    <div
                        ...
                        <div
                            class="bg-primary text-white rounded-full w-fit px-5 py-1 font-normal ml-2 mt-2 text-sm absolute">
                            Politik</div>
                        <img src="{{ asset('img/Berita-Demo.png') }}" alt="" class="w-full rounded-xl mb-3">
                ...
                <a href="{{ url('olahraga') }}">
                    <div
                        ...
                        <div
                            ...
                            Olahraga</div>
                        <img src="{{ asset('img/Berita-Motor.png') }}" alt="" class="w-full rounded-xl mb-3">
                        <p class="font-bold text-base mb-1">MotoGp 2025 Akan Diadakan Di <br>Sirkuit Mandalika</p>
                        <p class="text-slate-400">22 Januari 2024</p>
                    </div>
                </a>
                <a href="{{ url('gayahidup') }}">
                    <div
                        class="border border-slate-200 p-3 rounded-xl hover:border-primary hover:cursor-pointer transition duration-300 ease-in-out">
                        <div
                            class="bg-primary text-white rounded-full w-fit px-4 py-1 font-normal ml-2 mt-2 text-sm absolute">
                            Gaya Hidup</div>
                        <img src="{{ asset('img/Berita-Golf.png') }}" alt="" class="w-full rounded-xl mb-3">
